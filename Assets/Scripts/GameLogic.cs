...
public class GameLogic : MonoBehaviour
{
    ...
    public string shieldTriggerName;
    public string shieldUpTriggerName;
    public Animator astronautAnimator;
    public string astronautTriggerName;
    ...
    public void StartPuzzle()
    {
        ...
        InvokeRepeating("DisplayPattern", 3.5f, puzzleSpeed);
    ...
    public void ResetPuzzle()
    {
        ...
        //Reset ForceField
        shieldAnimator.SetTrigger(shieldUpTriggerName);
    ...
    public void PuzzleSuccess()
    {
        ...
        //Lower the shield
        astronautAnimator.SetTrigger(astronautTriggerName);
        shieldAnimator.SetTrigger(shieldTriggerName);
